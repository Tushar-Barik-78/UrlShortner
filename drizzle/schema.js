...
export const verifyEmailTokensTable = mysqlTable("is_email_valid", {
  ...
  expiresAt: timestamp("express_at")
...
export const userRelation = relations(userTable, ({ many }) => ({
  ...
  verify_email: many(verifyEmailTokensTable),
}));
...
// * verify email table relation with 
export const emailRelation = relations(verifyEmailTokensTable, ({ one }) => ({
  user: one(userTable, {
